...
<nav x-data="{ open: false, darkMode: window.getDarkMode() }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-4">
                <!-- Dark Mode Toggle -->
                <button 
                    @click="darkMode = !darkMode; window.toggleDarkMode()"
