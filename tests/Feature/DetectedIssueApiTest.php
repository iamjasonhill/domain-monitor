...
class DetectedIssueApiTest extends TestCase
{
    ...
    public function test_issues_endpoint_returns_normalized_open_issue_feed(): void
    {
        ...
        PropertyRepository::create([
            ...
            'local_path' => '/Users/jasonhill/Projects/Business/websites/headers-issue-site',
            'framework' => 'Astro',
            'is_primary' => true,
            'is_controller' => true,
    ...
    public function test_issues_endpoint_emits_one_issue_per_issue_family_for_one_property(): void
    {
        ...
        PropertyRepository::create([
            ...
            'repo_provider' => 'local_only',
            'local_path' => '/Users/jasonhill/Projects/Business/websites/multi-issue-site',
            'framework' => 'Astro',
            'is_primary' => true,
        ]);
    ...
    public function test_issues_endpoint_suppresses_expected_wordpress_system_404_noise_and_retired_author_archives(): void
    {
        ...
        PropertyRepository::create([
            ...
            'repo_provider' => 'local_only',
            'local_path' => '/Users/jasonhill/Projects/Business/websites/system-noise-site',
            'framework' => 'WordPress',
            'is_primary' => true,
        ]);
        ...
        PropertyRepository::create([
            ...
            'repo_provider' => 'local_only',
            'local_path' => '/Users/jasonhill/Projects/Business/websites/author-archive-site',
            'framework' => 'WordPress',
            'is_primary' => true,
        ]);
    ...
    public function test_issues_endpoint_does_not_treat_wp_json_as_expected_system_404_noise(): void
    {
        ...
        PropertyRepository::create([
            ...
            'repo_provider' => 'local_only',
            'local_path' => '/Users/jasonhill/Projects/Business/websites/wp-json-404-site',
            'framework' => 'WordPress',
            'is_primary' => true,
        ]);
    ...
    public function test_issues_endpoint_keeps_legacy_payment_404_active_without_explicit_replacement_target(): void
    {
        ...
        PropertyRepository::create([
            ...
            'repo_provider' => 'local_only',
            'local_path' => '/Users/jasonhill/Projects/Business/websites/legacy-payment-site',
            'framework' => 'WordPress',
            'is_primary' => true,
        ]);
    ...
    public function test_issues_endpoint_includes_broken_link_source_pages(): void
    {
        ...
        PropertyRepository::create([
            ...
            'local_path' => '/Users/jasonhill/Projects/Business/websites/broken-links-site',
            'framework' => 'Astro',
            'is_primary' => true,
            'is_controller' => true,
            'deployment_provider' => 'vercel',
