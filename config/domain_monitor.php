...
return [
    ...
    */
    'published_brand_surfaces' => [
        ...
        'brand_style_proposals' => [
            'quoting.movingcars.com.au' => [
                'source_marketing_domain' => 'movingcars.com.au',
                'property_slug' => 'movingcars-com-au',
                'surface_slug' => 'movingcars-quoting-vehicle-v1',
                'journey_type' => 'vehicle_quote',
                'approval_status' => 'approved',
                'approved_by' => 'domain-monitor',
                'approved_at' => '2026-05-20T09:00:00+10:00',
                'review_reason' => 'Vehicle pilot source-domain relationship and published brand style reviewed for MoverooCombined import.',
                'brand' => [
                ...
                'evidence' => [
                    [
                        'field' => 'source_marketing_domain',
                        'value' => 'movingcars.com.au',
                        'source_url' => 'https://movingcars.com.au',
                        'source_type' => 'reviewed_domain_monitor_property',
                        'confidence' => 'high',
                        'captured_at' => '2026-05-20T09:00:00+10:00',
                    ],
                    [
                        'field' => 'brand.display_name',
                        'value' => 'Moving Cars',
                        'source_url' => 'https://movingcars.com.au',
                        'source_type' => 'reviewed_published_surface_metadata',
                        'confidence' => 'high',
                        'captured_at' => '2026-05-20T09:00:00+10:00',
                    ],
                    [
            ...
            'mymovehub.backloading-services.com.au' => [
                'source_marketing_domain' => 'backloading-services.com.au',
                'property_slug' => 'backloading-services-com-au',
                'surface_slug' => 'backloading-services-mymovehub-v1',
                'journey_type' => 'mixed_quote',
                'approval_status' => 'needs_review',
                'review_reason' => 'Household/removals pilot source-domain relationship is mapped, but extracted style evidence still requires approval before it can become canonical style truth.',
                'brand' => [
                ...
                'evidence' => [
                    [
                        'field' => 'source_marketing_domain',
                        'value' => 'backloading-services.com.au',
                        'source_url' => 'https://backloading-services.com.au',
                        'source_type' => 'reviewed_domain_monitor_property',
                        'confidence' => 'high',
                        'captured_at' => '2026-05-20T09:00:00+10:00',
                    ],
            ...
            'quotes.interstate-removals.com.au' => [
                'source_marketing_domain' => 'interstate-removals.com.au',
                ...
                'approved_by' => 'domain-monitor',
                'approved_at' => '2026-05-20T09:00:00+10:00',
                'review_reason' => 'Household/removals pilot source-domain relationship and published brand style reviewed for MoverooCombined import.',
                'brand' => [
                ...
                'evidence' => [
                    [
                        'field' => 'source_marketing_domain',
                        'value' => 'interstate-removals.com.au',
                        'source_url' => 'https://interstate-removals.com.au',
                        'source_type' => 'reviewed_domain_monitor_property',
                        'confidence' => 'high',
                        'captured_at' => '2026-05-20T09:00:00+10:00',
                    ],
